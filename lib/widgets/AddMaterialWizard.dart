  ...
  Future<bool> _maybeDiscard() async {
    ...
    final result = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        title: Text(context.tr.discardChanges),
        content: Text(context.tr.discardChangesMsg),
        actions: [
          TextButton(
    ...
    setState(() {
      _sessionMaterials.add(
        _SessionMaterial(
          ...
          expiryDate:
              _existingExpiryDate?.toUtc().toIso8601String() ??
              product.expiryDate,
          body: body,
        ),
      );
  ...
  Future<void> _finishAndSave() async {
    ...
    for (final sessionItem in _sessionMaterials) {
      ...
      final order = OrderModel(
        ...
        expiryDate: sessionItem.expiryDate.isNotEmpty
          ...
          children: [
            Expanded(
              child: _buildSelectionCard(
                ...
                description: tr.addToExistingDesc,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          _infoRow(context.tr.materialName, p.name),
          _infoRow(context.tr.sku, p.sku),
          _infoRow(context.tr.quantity, p.quantity.toString()),
          _infoRow(context.tr.unit, p.unit),
          _infoRow(context.tr.storageLocation, p.location),
        ...
        children: [
          ...
          InkWell(
            ...
            child: InputDecorator(
              ...
              child: Text(
                date == null ? context.tr.selectDate : _formatDate(date),
                style: TextStyle(color: isDark ? Colors.white : Colors.black87),
              ),
            ),
          ),
