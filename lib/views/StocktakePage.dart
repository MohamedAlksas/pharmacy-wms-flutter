    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Expanded(child: _buildContent(context, products, grouped)),
        ],
      ),
    );
  }
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      '${products.length} ${context.tr.totalItems}',
                    ...
                    Text(
                      '${grouped.length} ${context.tr.storageLocationsLabel}',
                      style: TextStyle(
        ...
        children: [
          ...
          ...items.map(
            (item) => ListTile(
              ...
              trailing: Text(
                '${context.tr.qtyPrefix}${item.quantity}',
                style: TextStyle(
            ...
            return [
              ...
              ...sortedLocations.expand((location) {
                ...
                final label = location.isEmpty
                    ? context.tr.unspecified
                    : location;
                return [
                  pw.Header(
                    level: 1,
                    child: pw.Text(
                      '${context.tr.locationPrefix}$label  (${items.length} ${context.tr.itemsLabel})',
